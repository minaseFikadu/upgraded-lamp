...
prompt:
	...
	cin >> customer[user].transactions[customer[user].Index].amount;
    if (customer[user].transactions[customer[user].Index].amount <= acc_types[(customer[user].acc_type) - 1].max_withdraw  &&
        customer[user].transactions[customer[user].Index].amount < customer[user].balance &&
        ((customer[user].balance - customer[user].transactions[customer[user].Index].amount) > acc_types[customer[user].acc_type].initial)) {
            cout << "\nWithdraw made successfully!" << endl;
        	customer[user].balance -= customer[user].transactions[user].amount;
    ...
    {
        cout << "\nYou might have passed the maximum withdraw limit or " << endl
        << "You might not have enough amount in your balance " << endl
...
int deposit_page()
{
	...
	customer[user].balance += customer[user].transactions[customer[user].Index].amount;
	cout << "Now your balance is: " << customer[user].balance << endl;
	time_t now = time(0);
	char *date_time = ctime(&now);
	cout << "Transaction time: " << date_time << endl;
